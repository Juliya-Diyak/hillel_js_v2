...
Виберіть підходящі імена для змінних та створіть їх в коді.
       ...
       // `creationDate` - змінна для зберігання дати створення файлу.
       // `fileName` - змінна для зберігання імені файлу.
      // `errorCount` - змінна для зберігання кількості помилок.
...
// Об'явлення двох змінних: login та name
let login, name;

// Привласнення свого імені змінній name
name = "Юлія";

// Копіювання значення змінної name в login
login = name;

// Виведення значення змінної login в консоль
console.log(login);


/* Task - 3
        Створіть 3 змінні в одному рядку з різними значеннями */
       let variable1 = 20, variable2 = "Hello  Lviv", variable3 = true;
/* Task - 4
...
*/
       ...
       /*  let bigAmount = "500";
        ...
        let hugeAmount = parseInt(greatAmount) + parseInt(bigAmount);
...
*/
    ...
    /*  let inputX = 2;
        ...
        let newX1 = Number(inputX);
        let newY1 = Number(inputY);
...
let messageTemplate = `Привіт, мене звати ${name}. Мені ${age} років. Я працюю на посаді ${position} в компанії ${company}.`;
console.log(messageTemplate);

// За допомогою конкатенації
let messageConcatenation = "Привіт, мене звати " + name + ". Мені " + age + " років. Я працюю на посаді " + position + " в компанії " + company + ".";
